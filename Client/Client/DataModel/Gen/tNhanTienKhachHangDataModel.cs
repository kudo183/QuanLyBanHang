...
{
    public partial class tNhanTienKhachHangDataModel : BaseDataModel<tNhanTienKhachHangDto>
    {
        partial void ToDtoPartial(ref tNhanTienKhachHangDto dto);
        partial void FromDtoPartial(tNhanTienKhachHangDto dto);
        ...
        {
            var dataModel = obj as tNhanTienKhachHangDataModel;
            if (dataModel == null)
            {
                return;
            }
        ...
        public override tNhanTienKhachHangDto ToDto()
        {
        ...
        public override void FromDto(tNhanTienKhachHangDto dto)
        {
            State = dto.State;
            ID = dto.ID;

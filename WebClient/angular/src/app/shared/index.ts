import { HTopMenuModule, HTopMenuItem } from 'huypq-angular-top-menu';
import { HSimpleGridModule, HSimpleGridComponent, HSimpleGridSetting } from 'huypq-angular-simple-grid';
...
export { HSimpleGridModule, HSimpleGridSetting, HSimpleGridComponent };

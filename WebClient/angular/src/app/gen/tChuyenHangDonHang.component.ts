...
@Component({
  selector: 'app-tChuyenHangDonHang',
  templateUrl: './tChuyenHangDonHang.component.html'
})
export class tChuyenHangDonHangComponent implements OnInit, AfterViewInit {
  @ViewChild(HSimpleGridComponent) grid: HSimpleGridComponent;
  @Input() name = 'view_tChuyenHangDonHang';
  @Input() autoLoad = true;
  ...
  entities: Array<any>;
  className = 'tChuyenHangDonHangComponent';

...
SELECT        dbo.tNhapHang.Ngay, dbo.rNhanVien.Ma AS MaNV, dbo.rNhanVien.TenNhanVien, dbo.tMatHang.Ma AS MaMatHang, dbo.tMatHang.TenMatHang, 
                         dbo.tChiTietNhapHang.SoLuong, dbo.tChiTietNhapHang.SoLuong * dbo.tMatHang.SoKy AS SoKy, dbo.tNhapHang.MaKhoHang, dbo.tNhapHang.MaNhaCungCap
...
WHERE        (dbo.tNhapHang.Ngay BETWEEN '20150224' AND '20160229')
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vNhapHang2015';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vNhapHang2015';
